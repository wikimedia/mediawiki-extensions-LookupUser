...
$messages['af'] = array(
	...
	'lookupuser-intro' => "Sleutel 'n gebruikersnaam in om die gebruiker se voorkeure te sien.", # Fuzzy
...
$messages['ar'] = array(
	...
	'lookupuser-intro' => 'أدخل اسم مستخدم لرؤية تفضيلات هذا المستخدم.', # Fuzzy
 ...
 */
$messages['ast'] = array(
	'lookupuser' => 'Consultar información del usuariu',
	'lookupuser-desc' => '[[Special:LookupUser|Recuperar información]] tocante a un usuariu como la direición de corréu electrónicu y la ID',
	'lookupuser-intro' => "Escriba un nome d'usuariu pa ver les preferencies d'esi usuariu. Tamién pue usase una direición de corréu electrónicu, y amosará toles cuentes qu'usen esi corréu.",
	'lookupuser-nonexistent' => "Error: L'usuariu nun esiste",
	'lookupuser-authenticated' => 'identificáu el $1',
	'lookupuser-not-authenticated' => 'ensin identificar',
	'lookupuser-id' => "ID d'usuariu: <tt>nº$1</tt>",
	'lookupuser-email' => 'Corréu electrónicu: [[Special:EmailUser/$2|$1]]',
	'lookupuser-no-email' => 'nun se dio',
	'lookupuser-realname' => 'Nome real: $1',
	'lookupuser-registration' => 'Data de rexistru: $1',
	'lookupuser-no-registration' => 'nun se guardó',
	'lookupuser-touched' => "Rexistru d'usuarios tocáu por última vez: $1",
	'lookupuser-info-authenticated' => 'Comprobación del corréu electrónicu: $1',
	'lookupuser-useroptions' => 'Opciones del usuariu:',
	'lookupuser-foundmoreusers' => "Alcontróse más d'un usuariu:",
	'right-lookupuser' => "Consultar les preferencies d'usuariu",
	'action-lookupuser' => "consultar les preferencies d'usuariu",
);
...
$messages['bg'] = array(
	...
	'lookupuser-intro' => 'Въведете потребителско име за да видите предпочитанията и настройките на потребителя.', # Fuzzy
...
$messages['bn'] = array(
	...
	'lookupuser-intro' => 'কোনো ব্যবহারকারীর পছন্দ দেখতে ঐ ব্যবহারকারীর নাম প্রবেশ করান।', # Fuzzy
...
$messages['bs'] = array(
	...
	'lookupuser-intro' => 'Unesite korisničko ime da biste vidjeli postavke tog korisnika.', # Fuzzy
 ...
 */
$messages['cy'] = array(
	'lookupuser-authenticated' => 'dilyswyd am $1',
	'lookupuser-not-authenticated' => 'heb ei ddilysu',
	'lookupuser-id' => 'ID y defnyddiwr: <tt>#$1</tt>',
	'lookupuser-email' => 'E-bost: [[Special:EmailUser/$2|$1]]',
	'lookupuser-realname' => 'Yr enw cywir: $1',
	'lookupuser-registration' => 'Dyddiad cofrestru: $1',
	'lookupuser-no-registration' => 'heb ei gofnodi',
	'lookupuser-info-authenticated' => 'Dilysiad ebost: $1',
	'lookupuser-useroptions' => "Dewisiadau'r defnyddiwr:",
	'lookupuser-foundmoreusers' => 'Cafwyd hyd i fwy nag un defnyddiwr:',
	'right-lookupuser' => 'Gweld dewisiadau defnyddiwr',
	'action-lookupuser' => 'gweld dewisiadau defnyddiwr',
);
...
$messages['el'] = array(
	...
	'lookupuser-intro' => 'Εισάγετε ένα όνομα χρήστη για να εμφανιστούν οι προτιμήσεις αυτού του χρήστη.', # Fuzzy
...
$messages['eo'] = array(
	...
	'lookupuser-intro' => 'Enigi salutnomo rigardi la preferojn de tiu uzanto.', # Fuzzy
...
$messages['hi'] = array(
	...
	'lookupuser-intro' => 'एक सदस्यकी वरीयतायें देखने के लिये उसका नाम लिखें।', # Fuzzy
...
$messages['hr'] = array(
	...
	'lookupuser-intro' => 'Upišite suradničko ime da biste vidjeli njegove postavke.', # Fuzzy
...
$messages['hu'] = array(
	...
	'lookupuser-intro' => 'Add meg a felhasználó nevét, akinek meg szeretnéd nézni a beállításait.', # Fuzzy
...
$messages['id'] = array(
	...
	'lookupuser-intro' => 'Masukkan nama pengguna untuk melihat daftar preferensinya.', # Fuzzy
...
$messages['km'] = array(
	...
	'lookupuser-intro' => 'បញ្ចូល​អត្តនាមអ្នកប្រើប្រាស់ម្នាក់ដើម្បីមើលចំណង់ចំណូលចិត្តនានា​របស់គាត់។ អាសយដ្ឋានអ៊ីមែលក៏អាចប្រើបានដែរ ដែលការធ្វើបែបនេះ​នឹងបង្ហាញគណនីទាំងអស់ដែលកំពុងប្រើអីមែលនោះ។',
 ...
 */
$messages['ko'] = array(
	'lookupuser' => '사용자 정보 조회',
	'lookupuser-desc' => '이메일 주소와 ID 등 사용자에 대하여 [[Special:LookupUser|가져온 정보]]',
	'lookupuser-intro' => '해당 사용자의 환경 설정을 보기 위해서 사용자 이름을 입력해주세요.이메일 주소도 사용할 수 있으며 해당 이메일이 사용되는 모든 계정을 표시합니다.',
	'lookupuser-nonexistent' => '오류: 사용자가 존재하지 않습니다.',
	'lookupuser-authenticated' => '$1에 인증됨',
	'lookupuser-not-authenticated' => '인증되지 않음',
	'lookupuser-id' => '사용자 ID: <tt>#$1</tt>',
	'lookupuser-email' => '이메일: [[Special:EmailUser/$2|$1]]',
	'lookupuser-no-email' => '제공되지 않음',
...
$messages['lmo'] = array(
	...
	'lookupuser-intro' => 'Meta denter un suranom per vedè i sò preferenz.', # Fuzzy
...
$messages['lv'] = array(
	...
	'lookupuser-intro' => 'Ievadiet lietotājvārdu, lai apslatītu lietotāja uzstādījumus.', # Fuzzy
...
$messages['ml'] = array(
	...
	'lookupuser-intro' => 'ഒരു ഉപയോക്താവിന്റെ ക്രമീകരണങ്ങൾ നൽകാൻ ഉപയോക്തൃനാമം നൽകുക.', # Fuzzy
...
$messages['mr'] = array(
	...
	'lookupuser-intro' => 'एखाद्या सदस्याच्या पसंती पाहण्यासाठी त्याचे सदस्यनाव लिहा.', # Fuzzy
...
$messages['nb'] = array(
	...
	'lookupuser-intro' => 'Skriv inn et brukernavn for å vise brukerens innstillinger.', # Fuzzy
...
$messages['nn'] = array(
	...
	'lookupuser-intro' => 'Skriv inn eit brukarnamn for å vise innstillingane til brukaren.', # Fuzzy
...
$messages['oc'] = array(
	...
	'lookupuser-intro' => "Picar un nom d'utilizaire per veire sas preferéncias", # Fuzzy
...
$messages['scn'] = array(
	...
	'lookupuser-intro' => 'Nzirisci nu nomu utenti pi taliari li prifirenzi.', # Fuzzy
...
$messages['sk'] = array(
	...
	'lookupuser-intro' => 'Zadajte používateľské meno, ktorého nastavenia chcete zobraziť.', # Fuzzy
...
$messages['stq'] = array(
	...
	'lookupuser-intro' => 'Reek n Benutsernoome ien, uum die do persöönelke Ienstaalengen fon n Benutser antoukiekjen.', # Fuzzy
...
$messages['vec'] = array(
	...
	'lookupuser-intro' => 'Inserissi un nome utente par védarghine le preferense.', # Fuzzy
...
$messages['vi'] = array(
	...
	'lookupuser-registration' => 'Ngày mở tài khoản: $1',
...
$messages['vo'] = array(
	...
	'lookupuser-intro' => 'Penolös gebananami ad logön buükamis gebana at.', # Fuzzy
