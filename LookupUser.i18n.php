...
$messages['en'] = array(
	...
	'lookupuser-intro' => 'Enter a username to view the preferences of that user. An e-mail address can also be used, and will show all accounts using that e-mail.',
